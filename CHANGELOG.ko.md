...
[DESIGN.md](DESIGN.md) 스펙 확정(2026-07-20)부터 지금까지 — **v1.23.0**(2026-08-20)과 아직 릴리스되지 않은 커밋까지 — 커밋 **420개** 전수 기록.
...
| 버전 | 날짜 | 커밋 | 요약 |
|---|---|---|---|
| [Unreleased](#unreleased) | — | 2 | 대화가 보고 있는 프로젝트를 다른 곳에서 고치면 알려준다 |
