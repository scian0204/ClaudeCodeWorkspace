...
[DESIGN.md](DESIGN.md) 스펙 확정(2026-07-20)부터 지금까지 — **v1.25.1**(2026-08-21)까지 — 커밋 **436개** 전수 기록.
...
| 버전 | 날짜 | 커밋 | 요약 |
|---|---|---|---|
| [Unreleased](#unreleased) | — | 14 | 회사 계정으로 로그인(AD·SSO), 생김새가 보이는 위키, 프로젝트에 붙는 플러그인 |
