...
[DESIGN.md](DESIGN.md) 스펙 확정(2026-07-20)부터 지금까지 — **v1.25.1**(2026-08-21)까지 — 커밋 **433개** 전수 기록.
...
| 버전 | 날짜 | 커밋 | 요약 |
|---|---|---|---|
| [Unreleased](#unreleased) | — | 4 | 마켓플레이스에서 바로 설치, 전체 주소 대신 `foo/bar`, 데이터베이스 드라이버 빠진 이미지는 빌드에서 실패 |
