...
[DESIGN.md](DESIGN.md) 스펙 확정(2026-07-20)부터 **v1.19.8**(2026-08-18)까지 — 커밋 **366개** 전수 기록.
...
| 버전 | 날짜 | 커밋 | 요약 |
|---|---|---|---|
| [v1.19.8](#v1198--2026-08-18) | 2026-08-18 | 2 | 브라우저 로그인 계정에서도 모델 목록을 불러옴 |
