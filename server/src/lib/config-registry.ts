...
export function publicConfig(): { models: Record<string, string>; defaultModel: string; defaultEffort: string; sessionImportEnabled: boolean; sessionExportEnabled: boolean; sessionBundleEnabled: boolean; teamAgentsEnabled: boolean; llmProvidersEnabled: boolean; approvalsEnabled: boolean; dmEnabled: boolean; searchEnabled: boolean; customContextMenu: boolean; autoTitleEnabled: boolean; autoResumeEnabled: boolean; windowPrimerEnabled: boolean; gitPublishEnabled: boolean; wikiSourceEditEnabled: boolean; reviewWebhookEnabled: boolean; guideEnabled: boolean; guideWriteEnabled: boolean; asideEnabled: boolean; taskPanelEnabled: boolean; processPollMs: number; toolFoldMin: number; tokenPoolEnabled: boolean; tokenPoolAllUsers: boolean; tokenPoolPartyCreate: boolean; sessionSandboxEnabled: boolean } {
  return { models: modelMap(), defaultModel: cfg.str('defaultModel'), defaultEffort: cfg.str('defaultEffort'), sessionImportEnabled: cfg.bool('sessionImportEnabled'), sessionExportEnabled: cfg.bool('sessionExportEnabled'), sessionBundleEnabled: cfg.bool('sessionBundleEnabled'), teamAgentsEnabled: cfg.bool('teamAgentsEnabled'), llmProvidersEnabled: cfg.bool('llmProvidersEnabled'), approvalsEnabled: cfg.bool('approvalsEnabled'), dmEnabled: cfg.bool('dmEnabled'), searchEnabled: cfg.bool('searchEnabled'), customContextMenu: cfg.bool('customContextMenu'), autoTitleEnabled: cfg.bool('autoTitleEnabled'), autoResumeEnabled: cfg.bool('autoResumeEnabled'), windowPrimerEnabled: cfg.bool('windowPrimerEnabled'), gitPublishEnabled: cfg.bool('gitPublishEnabled'), wikiSourceEditEnabled: cfg.bool('wikiSourceEditEnabled'), reviewWebhookEnabled: cfg.bool('reviewWebhook'), guideEnabled: cfg.bool('guideEnabled'), guideWriteEnabled: cfg.bool('guideWriteEnabled'), asideEnabled: cfg.bool('asideEnabled'), taskPanelEnabled: cfg.bool('taskPanelEnabled'), processPollMs: cfg.int('processPollMs'), toolFoldMin: cfg.int('toolFoldMin'), tokenPoolEnabled: cfg.bool('tokenPoolEnabled'), tokenPoolAllUsers: cfg.bool('tokenPoolAllUsers'), tokenPoolPartyCreate: cfg.bool('tokenPoolPartyCreate'), sessionSandboxEnabled: cfg.bool('sessionSandboxEnabled') };
}
