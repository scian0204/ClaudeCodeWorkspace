...
// Push to everyone currently looking at one chat. Used by work that starts outside a request — the
// project watcher, which fires when a file changes, not when someone clicks.
