...
// Wiki topic file explorer. Admins additionally get source management on raw/: drop in new files
// and edit existing text sources in place. Neither recompiles on its own (the compile is a Claude
// run), so a change raises a "recompile needed" bar with the button right there.
