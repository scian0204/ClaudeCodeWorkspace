...
export const db = {
  ...
  reviewRepos: [
    { id: 'rr_web', name: 'acme/webapp', provider: 'github', host: 'github.com', slug: 'acme/webapp', gitUrl: 'https://github.com/acme/webapp.git', baseBranch: 'main', sandboxImage: null, webhookSecret: null, polledAt: ago(2), pollError: null, openCount: 2, createdAt: ago(600) },
  ] as any[],
  reviewSessions: [
