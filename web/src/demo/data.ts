...
export const ADMIN = {
  ...
  defaultEffort: 'high',
  images: { 'node:20-bookworm': { present: true, size: 402_000_000 }, 'codercom/code-server:latest': { present: false },
    'mcr.microsoft.com/dotnet/framework/sdk:4.8': { present: false } } as Record<string, any>,
  // the remote Windows build host's reachability, as the admin panel's test button reports it
  winDocker: { configured: true, ok: true, os: 'windows', version: '27.4.0', error: null, checkedAt: Date.now() },
  ...
  config: [
    ...
    { key: 'browserEnabled', group: 'browser', type: 'bool', value: '1', default: '0', restart: false, readonly: false, secret: false, overridden: true },
    { key: 'browserImage', group: 'browser', type: 'string', value: 'mcr.microsoft.com/playwright/mcp:latest', default: 'mcr.microsoft.com/playwright/mcp:latest', restart: false, readonly: false, secret: false, overridden: false, image: true },
    { key: 'browserMemMB', group: 'browser', type: 'int', value: '2048', default: '2048', unit: 'MB', min: 256, max: 65536, restart: false, readonly: false, secret: false, overridden: false },
    { key: 'browserIdleMs', group: 'browser', type: 'int', value: '1800000', default: '1800000', unit: 'ms', min: 60000, max: 86400000, restart: false, readonly: false, secret: false, overridden: false },
    { key: 'winSandboxEnabled', group: 'windocker', type: 'bool', value: '1', default: '0', restart: false, readonly: false, secret: false, overridden: true },
    { key: 'winDockerHost', group: 'windocker', type: 'string', value: 'tcp://win-build:2376', default: '', restart: false, readonly: false, secret: false, overridden: true },
    { key: 'winDockerCertDir', group: 'windocker', type: 'string', value: '/certs/win', default: '', restart: false, readonly: false, secret: false, overridden: true },
    { key: 'winSandboxImage', group: 'windocker', type: 'string', value: 'mcr.microsoft.com/dotnet/framework/sdk:4.8', default: 'mcr.microsoft.com/dotnet/framework/sdk:4.8', restart: false, readonly: false, secret: false, overridden: false, image: true, imageHost: 'windows' },
    { key: 'winSandboxWorkdir', group: 'windocker', type: 'string', value: 'C:\\project', default: 'C:\\project', restart: false, readonly: false, secret: false, overridden: false },
    { key: 'winSandboxIsolation', group: 'windocker', type: 'select', options: ['default', 'process', 'hyperv'], value: 'default', default: 'default', restart: false, readonly: false, secret: false, overridden: false },
    { key: 'winSandboxShell', group: 'windocker', type: 'select', options: ['cmd', 'powershell'], value: 'cmd', default: 'cmd', restart: false, readonly: false, secret: false, overridden: false },
    { key: 'winSandboxMemMB', group: 'windocker', type: 'int', value: '8192', default: '8192', min: 512, max: 262144, unit: 'MB', restart: false, readonly: false, secret: false, overridden: false },
    { key: 'winSandboxExecTimeoutMs', group: 'windocker', type: 'int', value: '1800000', default: '1800000', min: 10000, max: 14400000, unit: 'ms', restart: false, readonly: false, secret: false, overridden: false },
    { key: 'winSandboxIdleMs', group: 'windocker', type: 'int', value: '3600000', default: '3600000', min: 60000, max: 86400000, unit: 'ms', restart: false, readonly: false, secret: false, overridden: false },
    { key: 'winSandboxSyncMaxMB', group: 'windocker', type: 'int', value: '512', default: '512', min: 1, max: 20480, unit: 'MB', restart: false, readonly: false, secret: false, overridden: false },
    { key: 'winSandboxSyncExclude', group: 'windocker', type: 'string', value: '.git,node_modules,bin,obj,packages,.vs,dist,target,.next', default: '.git,node_modules,bin,obj,packages,.vs,dist,target,.next', restart: false, readonly: false, secret: false, overridden: false },
